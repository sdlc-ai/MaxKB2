export default {
  ...
  defaultTip: 'The default is the Porsche platform interface, supports custom settings',
  logoDefaultTip: 'The default is the Porsche login interface, supports custom settings',
